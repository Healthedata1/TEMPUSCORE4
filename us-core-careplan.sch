...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CarePlan/f:category">
      <sch:assert test="exists(f:coding/code[@value='assess-plan']) and exists(f:coding/system[@value='http://hl7.org/fhir/us/core-r4/CodeSystem/careplan-category'])">Must have a category of 'assess-plan' and a code system 'http://hl7.org/fhir/us/core-r4/CodeSystem/careplan-category'</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
